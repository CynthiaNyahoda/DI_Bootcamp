    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hotel', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='torquay.hotels')),
            ],
        ),
        migrations.CreateModel(
            name='Reservation',
            fields=[
                ...
                ('room', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='torquay.rooms')),
            ],
        ),
    ]
