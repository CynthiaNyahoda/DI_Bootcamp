...
def my_view(request):
    ...
    context = {'todays_date': todays_date, 'max_date': max_date}
...
def homepage(request):
    ...
    if request.method =="POST":
        try:
            ...
            response = render(request,'basics/index.html',data)
        except Exception as e:
            messages.error(request,e)
            response = render(request,'basics/index.html', {'all_location':all_location})
